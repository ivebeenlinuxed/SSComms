...
/**
 * Autogenerated class for API access to the model \Model\Venue_Check_Selected_Question
 * 
 * PHP version 5.4
 *
 * @category API
 ...
 *
 */
class Venue_Check_Selected_Question extends \Controller\Api\ModelController {
	...
	protected function getModelClass() {
		return "\Model\VenueCheckSelectedQuestion";
	}
}