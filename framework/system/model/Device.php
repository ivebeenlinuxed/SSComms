<?php
/**
 * Autogenerated model for \Model\Device
 * 
 * PHP version 5.4
 *
 * @category Model
 ...
 *
 */
class Device extends \Model\DBObject {
	...
	*/
	...
	public static function getDBColumns() {
		return array("id","name","code","fingerprint","pin","status");
	}
	
	/**
	 * Gets the table name (always returns "device")
	 * 
